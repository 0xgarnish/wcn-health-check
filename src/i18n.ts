...
interface Translation {
  ...
  addContext: string
  footer: string
  stages: { name: string; title: string }[]
  categories: CategoryTranslation[]
}

// Base categories structure (English)
const categoriesEN: CategoryTranslation[] = [
  {
...
export const translations: Record<Language, Translation> = {
  ...
  es: {
    ...
    categories: [
      { name: 'Registro y Gobernanza', questions: [
        ...
        { title: 'Gobernanza de la Junta', desc: 'Liderazgo y supervisión' },
        { title: 'Liderazgo Senior', desc: 'Gestión ejecutiva' },
      ...
      { name: 'Recursos Humanos', questions: [
        ...
        { title: 'Capacidad y Desarrollo', desc: 'Formación y crecimiento' },
        { title: 'Comunicaciones Internas', desc: 'Flujo de información' },
      ...
      { name: 'Finanzas y Contabilidad', questions: [
        ...
        { title: 'Presupuestos', desc: 'Planificación financiera' },
      ...
      { name: 'Compromiso con la Comunidad', questions: [
        ...
        { title: 'Responsabilidad', desc: 'Responsabilidad comunitaria' },
      ...
      { name: 'Marketing y Comunicaciones', questions: [
        { title: 'Estrategia de Comunicación', desc: 'Enfoque de mensajes' },
        { title: 'Marca Visual', desc: 'Identidad organizacional' },
  ...
  fr: {
    ...
    previous: '← Précédent',
    next: 'Suivant →',
    categoryComplete: '✓ Catégorie complète!',
    completeAll: 'Compléter tout',
    ...
    categories: [
      { name: 'Enregistrement et Gouvernance', questions: [
        ...
        { title: 'Direction Générale', desc: 'Gestion exécutive' },
      ...
      { name: 'Ressources Humaines', questions: [
        { title: 'Descriptions de Poste', desc: 'Clarté des rôles' },
        { title: 'Rémunération et Avantages', desc: 'Salaires du personnel' },
        { title: 'Capacité et Développement', desc: 'Formation et croissance' },
      ...
      { name: 'Planification Stratégique', questions: [
        ...
        { title: 'Impact sur la Conservation', desc: 'Mesure des résultats' },
      ...
      { name: 'Finance et Comptabilité', questions: [
        ...
        { title: 'Audits', desc: 'Examen indépendant' },
      ]},
  ...
  pt: {
    ...
    categories: [
      ...
      { name: 'Recursos Humanos', questions: [
        ...
        { title: 'Capacidade e Desenvolvimento', desc: 'Treinamento e crescimento' },
  ...
  ru: {
    ...
    addContext: 'Добавить контекст (опционально)...',
  ...
  ms: {
    ...
    addContext: 'Tambah konteks (pilihan)...',
    ...
    categories: [
      ...
      { name: 'Sumber Manusia', questions: [
        ...
        { title: 'Kapasiti dan Pembangunan', desc: 'Latihan dan pertumbuhan' },
  ...
  id: {
    ...
    categoryComplete: '✓ Kategori selesai!',
    completeAll: 'Selesaikan semua',
    addContext: 'Tambahkan konteks (opsional)...',
    ...
    categories: [
      ...
      { name: 'Sumber Daya Manusia', questions: [
        ...
        { title: 'Kapasitas dan Pengembangan', desc: 'Pelatihan dan pertumbuhan' },
  ...
  sw: {
    ...
    next: 'Ifuatayo →',
    categoryComplete: '✓ Jamii imekamilika!',
    completeAll: 'Kamilisha yote',
    addContext: 'Ongeza muktadha (hiari)...',
    ...
    categories: [
      ...
      { name: 'Rasilimali Watu', questions: [
        ...
        { title: 'Uwezo na Maendeleo', desc: 'Mafunzo na ukuaji' },
  ...
  ne: {
    ...
    previous: '← अघिल्लो',
    next: 'अर्को →',
    categoryComplete: '✓ श्रेणी पूरा!',
    completeAll: 'सबै पूरा गर्नुहोस्',
    addContext: 'सन्दर्भ थप्नुहोस् (ऐच्छिक)...',
    ...
    categories: [
      ...
      { name: 'मानव संसाधन', questions: [
        ...
        { title: 'क्षमता र विकास', desc: 'तालिम र वृद्धि' },
  ...
  rw: {
    ...
    categories: [
      ...
      { name: 'Imari y\'Abantu', questions: [
        ...
        { title: 'Ubushobozi n\'Iterambere', desc: 'Amahugurwa n\'iterambere' },
  ...
  lg: {
    ...
    completeAll: 'Tuukiriza byonna',
    addContext: 'Yongera ebigambo (si kyetaagisa)...',
    ...
    categories: [
      ...
      { name: 'Obugagga bw\'Abantu', questions: [
        ...
        { title: 'Obuyinza n\'Okukula', desc: 'Okutendeka n\'okukula' },
      ...
      { name: 'Enteekateeka Enkulu', questions: [
        ...
        { title: 'Okukuuma n\'Okusenguka', desc: 'Okuyiga n\'okukyusa' },
      ]},
  ...
  om: {
    ...
    previous: '← Duraa',
    next: 'Itti aanee →',
    categoryComplete: '✓ Gareen xumurameera!',
    completeAll: 'Hunda xumurii',
    addContext: 'Haala dabalii (dirqama miti)...',
    ...
    categories: [
      ...
      { name: 'Qabeenya Namaa', questions: [
        ...
        { title: 'Dandeettii fi Guddina', desc: 'Leenjii fi guddina' },
  ...
  sn: {
    ...
    completeAll: 'Pedzisa zvose',
    addContext: 'Wedzera mashoko (zvirikundichengeta)...',
    ...
    categories: [
      ...
      { name: 'Simba reVanhu', questions: [
        ...
        { title: 'Simba neKukura', desc: 'Kudzidzisa nekukura' },
  ...
  tn: {
    ...
    next: 'E e latelang →',
    categoryComplete: '✓ Karolo e weditswe!',
    completeAll: 'Wetsa tsotlhe',
    addContext: 'Tsenya tshedimosetso (ga e tlhokege)...',
    ...
    categories: [
      ...
      { name: 'Dikhumo tsa Batho', questions: [
        ...
        { title: 'Bokgoni le Tlhabololo', desc: 'Thupelo le kgolo' },
  ...
  bem: {
    ...
    completeAll: 'Pwisheni fyonse',
    addContext: 'Ongeleni amalandwe (si lyakwata)...',
    ...
    categories: [
      ...
      { name: 'Icuma ca Bantu', questions: [
        ...
        { title: 'Amaka no Kukula', desc: 'Ukusambilila no kukula' },
  ...
  uz: {
    ...
    completeAll: 'Hammasini tugallang',
    addContext: 'Kontekst qo\'shing (ixtiyoriy)...',
    ...
    categories: [
      ...
      { name: 'Inson resurslari', questions: [
        ...
        { title: 'Imkoniyat va Rivojlanish', desc: 'O\'qitish va o\'sish' },
